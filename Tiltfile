...
if os.getenv('KKA_DEPLOY_MINIMAL', 'false') == 'false':
    ...
    k8s_yaml(helm(
        ...
        'applications[0].source.helm.values.repoURL={}'.format(os.getenv('KKA_REPO_URI')),
        'applications[0].source.helm.values.targetRevision={}'.format(os.getenv('KKA_REPO_BRANCH'))]
    ))
