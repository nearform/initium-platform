...
default: generate-dex-certs kind-up tilt-up
...
generate-dex-certs: ## Generate TLS assets for running Dex with HTTPS and to be used by cluster API server
	@./scripts/generate-dex-certs.sh
